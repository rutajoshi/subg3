...
import {
  ...
  TokenCreated
} from "../generated/Subg3Contract/Subg3Contract"
...
export function handleTokenCreated(event: TokenCreated): void {
  ...
  let token = new CreatorToken(event.params.tokenAddress.toHex())
  token.tokenAddress = event.params.tokenAddress
  token.name = userId //event.params.name
